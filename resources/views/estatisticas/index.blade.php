<x-app-layout>
    ...
    <div class="sm:w-5/6 w-full ml-auto lg:px-12 p-4">
        ...
        <div class="flex sm:flex-row justify-between flex-col">
            <x-card-pagamentos />
            <div class="flex text-blue-700 flex-row-reverse sm:mt-0 mt-4">
                <p type="button" onclick="abreModalAbaEstatistica()"
        ...
        <div class="mt-4">
            <div class="bg-white rounded-lg w-full sm:w-2/3 shadow-lg mt-6">
                <div class="p-4 font-light">
                    <div class="flex justify-between text-sm text-gray-800">
                        <div class="flex flex-col space-y-4 mt-2">
                            <span class="tex-sm sm:text-xl text-gray-700 font-bold">Boletos</span>
                            <span class="text-xs">R$ 0,00</span>
                            <span class="text-xs sm:text-sm">R$ 0,00</span>
                        </div>
                        <div class="flex flex-col space-y-4 mt-2">
                            <span class="tex-sm sm:text-xl text-gray-700 font-bold">Transferências</span>
                            <span class="text-xs sm:text-sm">R$ 0,00</span>
                            <span class="text-xs sm:text-sm">R$ 0,00</span>
                        </div>
                        <div class="flex flex-col space-y-4 mt-2">
                            <span class="tex-sm sm:text-xl text-gray-700 font-bold">PayPal</span>
                            <span class="text-xs sm:text-sm">R$ 0,00</span>
                            <span class="text-xs sm:text-sm">R$ 0,00</span>
                        </div>
                        <div class="flex flex-col space-y-4 mt-2">
                            <span class="tex-sm sm:text-xl text-gray-700 font-bold">Diver. Pendentes</span>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-xs sm:text-sm">R$ 0,00</span>
                            </div>
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                    class="w-4 h-4 sm:w-5 sm:h-5 text-yellow-500">
        ...
        <div class="mt-16">
            ...
            <div class="block sm:flex flex-row-reverse">
                <form action="#" class="mt-1 flex flex-col space-x-1 p-4 items-end border rounded bg-white">
                    ...
                    <div id="exibeParaCustomizado" class="hidden w-full">
                        <div class="flex flex-col mt-1">
                            ...
                            <input id="data_inicial" type="date" name="data_inicial" required
                                class="px-1 py-1 sm:w-96 w-full border outline-none rounded bg-white border-gray-200 text-sm text-gray-600">
                        </div>

                        <div class="flex flex-col mt-1">
                            <label for="data_final" class="text-sm text-gray-700">Data Final</label>
                            <input id="data_final" type="date" name="data_final" required
                                class="px-1 py-1 sm:w-96 w-full border outline-none rounded bg-white border-gray-200 text-sm text-gray-600">
                        </div>
              ...
              bg-green-600 px-2 py-1.5 w-full">
                            Buscar
                        </button>
                    </div>
                </form>
            ...
            <div class="flex items-center sm:mt-0 mt-8">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-9 h-9 stroke-gray-500">
