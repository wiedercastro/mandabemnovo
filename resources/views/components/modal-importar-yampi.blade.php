<div class="justify-center items-center hidden" id="modal_importar_yampi">
  <div>
    <!-- Open modal button -->
    <!-- Modal Overlay -->
    ...
    <div class="fixed inset-0 px-2 z-10 overflow-hidden flex items-start justify-center animate__animated animate__fadeIn">
      ...
      <div
        ...
        <!-- Modal Header -->
        <div class="bg-orange-500 text-white px-4 py-4 flex justify-between">
          <div class="flex items-center">
            ...
            <h2 class="text-2xl font-bold ml-2">
              Importar Pedidos Yampi
            </h2>
          </div>
          <svg
            onclick="fechaModalImportarYampi()"
          ...
          <form action="" method="GET">
            ...
            <div class="flex flex-col w-full mt-4">
              ...
              <select name="status_pedido" id="status_pedido" class="text-gray-700 shadow p-1 w-full border-1 rounded outline-none border-gray-200 focus:border-blue-500">
                ...
                <option value="somente_pagos">Somente Pagos</option>
                <option value="aguardando_pagamento">Aguardando Pagamento</option>
                <option value="cancelado">Cancelado</option>
                <option value="em_transporte">Em transporte</option>
                <option value="entregue">Entregue</option>
                <option value="excecao_entrega">Exceção de entrega</option>
                <option value="aprovado">Pagamento Aprovado</option>
                <option value="nao_aprovado">Pagamento não Aprovado</option>
                <option value="pedido_autorizado">Pedido Autorizado</option>
                <option value="realizado">Pedido Realizado</option>
                <option value="em_separacao">Produdos em Separação</option>
