<div class="justify-center items-center hidden" id="modal_deleta_faq">
    <div class="fixed inset-0 px-2 z-10 flex items-center justify-center animate__animated animate__fadeIn pb-16">
        ...
        <div
            ...
            <div class="relative bg-white rounded-lg">
                <button onclick="cancelaDelecaoFaq()" type="button" class="absolute top-3 end-2.5 text-gray-400 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center">
