<div class="justify-center items-center hidden" id="modal_importar_fastcommerce">
  <div>
    <!-- Open modal button -->
    <!-- Modal Overlay -->
    ...
    <div class="fixed inset-0 px-2 z-10 overflow-hidden flex items-start justify-center animate__animated animate__fadeIn">
      ...
      <div
        ...
        <!-- Modal Header -->
        <div class="bg-cyan-500 text-white px-4 py-4 flex justify-between">
          <div class="flex items-center">
            ...
            <h2 class="text-2xl font-bold ml-2">
              Importar Pedidos FastCommerce
            </h2>
          </div>
          <svg
            onclick="fechaModalImportarFastCommerce()"
