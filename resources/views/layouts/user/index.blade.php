    ...
    <div class="sm:w-5/6 w-full ml-auto lg:px-12 pb-10 animate__animated animate__fadeIn p-4">
      ...
      <div class="flex sm:flex-row justify-between flex-col mt-6">
        ...
        <div class="flex flex-row-reverse">
          <form action="#" method="GET" class="mt-1 w-full flex sm:flex-row flex-col space-x-1 sm:space-y-0 space-y-2 p-4 items-end border rounded bg-white">
            ...
            <div class="flex flex-col w-full sm:w-max">
              <select 
                ...
                class="px-1 py-1 sm:w-40 w-full border outline-none rounded bg-white border-gray-200 text-sm text-gray-500">
