      ...
      <div class="w-full">
          <div x-data="{ open: false }" class="flex flex-row-reverse">
              ...
              <div x-show="open" @click.away="open = false" class="w-full fixed inset-0 overflow-y-auto">
                  <div
                      class="w-full flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                      ...
                      <div x-show="open"
                          class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3x1"
                                      ...
                                      <div class="w-full mx-auto bg-white p-8 border rounded-md mt-8">
                                          ...
                                          <form action="" method="POST">
                                              ...
                                              <div class="flex w-full" style="border: 0px solid red; width: 800px;">
                                                  ...
                                                  <div class=" w-fullmb-4 mr-4">
                                                      ...
                                                      <input type="text" name="title" id="title"
                                                          class="w-full border p-2 rounded" value="Principal">
                                                  </div>
                                                  ...
                                                  <div class="w-full mb-4 mr-4">
                                                      ...
                                                      <input type="text" name="delivery_address"
                                                          id="delivery_address" class="w-full border p-2 rounded">
                                                  </div>
                                              ...
                                              <div class="flex justify-end">
                                                  <button type="submit"
                                                      class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Salvar
                                                      Envior</button>
