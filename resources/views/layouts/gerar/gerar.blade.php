<x-app-layout>
  ...
  <div class="w-5/6 ml-auto lg:px-12">
    ...
    <x-modal-bling/>
    <x-modal-loja-integrada/>
    <x-modal-importar-nuvem/>
    <x-modal-importar-pedidos-tiny/>
    <x-modal-importar-yampi/>
    <x-modal-importar-shopify/>
    <x-modal-importar-fastcommerce/>
    ...
    <div class="w-full">
      <div x-data="{ open: false }" class="flex flex-row-reverse">
        ...
        <div class="flex text-xs mt-12">
          <button 
            onclick="abreModalLojaIntegrada()"
          ...
          <button 
            onclick="abreModalImportarNuvem()"
          ...
          <button 
            onclick="abreModalImportarTiny()"
            class="bg-gray-500 hover:bg-gray-700 text-white font-bold px-2 py-1 rounded ml-2 flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
              <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
            </svg>                                   
            <p class="ml-1">Importar Tiny</p>
          </button>
          <button 
            onclick="abreModalImportarYampi()"
            class="bg-orange-500 hover:bg-orange-700 text-white font-bold px-2 py-1 rounded ml-2 flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
              <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
            </svg>                                   
            <p class="ml-1">Importar Yampi</p>
          </button>
          <button 
            onclick="abreModalImportarShopify()"
            class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold px-2 py-1 rounded ml-2 flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
              <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
            </svg>                                   
            <p class="ml-1">Importar shopify</p>
          </button>
          <button 
            onclick="abreModalImportarFastCommerce()"
            class="bg-cyan-500 hover:bg-cyan-700 text-white font-bold px-2 py-1 rounded ml-2 flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
              <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
            </svg>                                   
            <p class="ml-1">Importar FasatCommerce</p>
          </button>
