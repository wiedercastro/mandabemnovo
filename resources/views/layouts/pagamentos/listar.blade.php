<x-app-layout>
    <div class="w-5/6 ml-auto lg:px-12">
        <div class="w-full">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="resultadoModalLabel">Resultado da Operação</h5>
            ...
            <div class="flex h-96 space-x-4 mt-2">
                <div class="p-4 bg-white w-full rounded-md shadow-md flex flex-col justify-between">
                    <div>
                        ...
                        <div class="mt-2 text-gray-600 text-sm">
                            ...
                            <hr class="mt-4">
                            <p class="font-light mt-4">Depois de fazer a transferência basta incluir o comprovante no
                                link abaixo que colocaremos o crédito o mais rápido possível.</p>
                        </div>
                    </div>
                ...
                <div class="p-4 bg-white w-full rounded-md shadow-md flex flex-col justify-between">
                    <div>
                        ...
                        <div class="text-gray-600 text-sm">
                            <p class="font-light mt-4">Em sua conta do Mercado Pago clique em: "Enviar dinheiro" para:
                            </p>
                            <p class="mt-6 font-bold text-gray-500">marcos@mandabem.com.br</p>
                            <p class="mt-6 font-light ">Depois é só incluir o compravante no link abaixo que colocaremos
                                o crédito o mais rápido possível.</p>
                        </div>
                    </div>
                ...
                <div class="w-full flex flex-col">
                    <div class="bg-white  flex-1 p-4 rounded-md shadow-md">
                        ...
                        <form id="gerarQR" method="POST" action="" class="mt-4">
                            @csrf
                            <div class="flex flex-col">
                                <label for="" class="text-sm text-gray-700">Informe o valor</label>
                                <input type="text" id="valor_pix" name="valor_pix"
                                    class="text-gray-700 shadow p-1 w-48 rounded outline-none border-gray-200 focus:border-gray-200">
                            </div>
                    ...
                    <div class="bg-white flex-1 p-4 mt-2 rounded-md shadow-md">
