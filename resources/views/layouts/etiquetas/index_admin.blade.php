                        ...
                        <tr id="detalhes_admin_{{$envio->id}}" class="hidden">
                            <td colspan="12" class="bg-blue-100 p-4" > 
                                <div class="flex justify-between">
                                    <div>
                                        <h4 class="font-bold">DESTINO</h4>
                                        <div class="text-sm mt-4">
                                            <p>Kelly Cristine Silva</p>
                                            <p>CEP: 02873560</p>
                                        </div>
                                    </div>
                                    <div>
                                        <h4 class="font-bold">ETIQUETA</h4>
                                        <div class="mt-4">
                                            <p class="text-sm font-bold">AA049836142BR</p>
                                    ...
                                    <div>
                                        <h4 class="font-bold">DESCONTO</h4>
                                        <div class="text-sm mt-4">
                                            <p>R$ 20,00</p>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <h4 class="font-bold">CORREIOS</h4>
                                        <div class="text-sm mt-4">
                                            <p>--</p>
                                        </div>
                                    </div>
                                    <div>
                                        <h4 class="font-bold">MB + PAYPAL</h4>
                                        <div class="text-sm mt-4">
                                            <p>--</p>
                                        </div>
                                    </div>
                                ...
                                <div class="bg-gray-100 shadow mt-4 p-1 rounded">
                                    <div class="flex justify-between">
                                        <div class="flex flex-col w-full justify-center items-center">
                                            ...
                                            <span>Rua Francisco Bullutas - 14
                                                Jardim Elisa Maria
                                                02873560 - São Paulo/SP
                                            </span>
                                        </div>
                                        <div class="w-full flex justify-center items-center">
                                            <div class="flex items-center flex-col">
                                                ...
                                                <span>k.cristiine.silva@gmail.com</span>
                                            </div>
                                        </div>
                                        <div class="w-full flex justify-center items-center">
                                            <div class="flex items-center flex-col">
                                    ...
                                    <div class="flex justify-between p-4">
                                        <div class="flex flex-col">
                                            <div class="flex">
                                                ...
                                                <p class="ml-1 text-blue-400 italic">Não</p>
                                            </div>
                                            <div class="flex">
                                        ...
                                        <div class="flex flex-col">
                                            <div class="flex">
                                                ...
                                                <p class="ml-1 text-blue-400 italic">0.300 Kg</p>
                                            </div>
                                            <div class="flex">
                                        ...
                                        <div class="flex flex-col">
                                            <div class="flex">
                                                ...
                                                <p class="ml-1 text-blue-400 italic">6 dias úteis</p>
                                            </div>
                                            <div class="flex">
                                        ...
                                        <div>
                                            ...
                                            <button class="bg-cyan-700 mt-2 hover:bg-cyan-800 text-white  w-full text-xs font-bold px-2 py-1 rounded flex items-center text-sm">        
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
