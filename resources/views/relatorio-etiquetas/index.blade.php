<x-app-layout>
  ...
  <div class="sm:w-5/6 w-full ml-auto lg:px-12 p-4 sm:p-0">
    ...
    <div class="flex flex-col sm:flex-row justify-between mt-10 sm:mt-0">
      ...
      <form action="#" class="mt-1 flex flex-col space-x-1 p-4 border rounded bg-white">
        <div>
          <div class="flex flex-col mt-1">
            ...
            <input 
              ...
              name="data_inicial"
              required
              class="px-1 py-1 w-full sm:w-96 border outline-none rounded bg-white border-gray-200 text-sm text-gray-600">
          </div>
