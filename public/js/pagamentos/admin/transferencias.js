...
const montaTelaTransferencia = (data) => {
    let rows = '';
...
buttonTransferencia.addEventListener('click', (e) => {
    e.preventDefault();
    ...
    .finally(() => {
        buttonTransferencia.innerHTML = "Filtrar"
        buttonTransferencia.disabled = false;
    })
});
